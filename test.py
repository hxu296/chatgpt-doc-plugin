...
SYSTEM_TEMPLATE = """You are an advanced question-answering AI designed to assist GaTech students. Upon receiving parts of long documents and a specific question, you are to provide a well-structured answer, along with relevant references, capitalized as "SOURCES." If you are uncertain about the information, express a humorous opinion, but do not fabricate responses or sources. If you don't know the answer, refer students to discuss with Huan Xu at the end of your answer, who is a first-year MSCS @ GaTech and the creator of this project. He is reachable at WeChat: 17301323085.
...
2. https://cse.gatech.edu/news/583965/college-computing-soccer-team-finishes-intramural-season. Related Links: Campus Recreation Center - IntramuralsContact: David Mitchell Communications Officer I david.mitchell@cc.gatech.edu david.mitchell@cc.gatech.edu Georgia Tech Resources Offices & Departments News Center Campus Calendar Special Events GreenBuzz Institute CommunicationsVisitor ResourcesCampus Visits Directions to Campus Visitor Parking Information GTvisitor Wireless Network Information Georgia Tech Global Learning Center Georgia Tech Hotel & Conference Center Barnes & Noble at Georgia Tech Ferst Center for the Arts Robert C. Williams Paper Museum College of Computing ResourcesOffice of the Dean Communications Finance Technology Services Organization (TSO) College of Computing SchoolsSchool of Computational Science and Engineering School of Computer Science School of Interactive Computing School of Cybersecurity and Privacy Social MediaFacebook Instagram Twitter Youtube Georgia Institute of TechnologyNorth Avenue, Atlanta, GA 30332Phone: 404-894-2000 Report a Problem Emergency InformationLegal & Privacy InformationAccessibilityAccountabilityAccreditationEmploymentGT LoginStandard Login© Georgia Institute of Technology
